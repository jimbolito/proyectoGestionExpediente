...
export class ExpedientParalyzedReasonController {
  ...
  async find(
    ...
    return this.expedientRepository.paralyzedReasonId(id).find(filter);
  }
  ...
  async create(
    ...
    return this.expedientRepository.paralyzedReasonId(id).create(paralyzedReason);
  }
  ...
  async patch(
    ...
    return this.expedientRepository.paralyzedReasonId(id).patch(paralyzedReason, where);
  }
  ...
  async delete(
    ...
    return this.expedientRepository.paralyzedReasonId(id).delete(where);
  }
}
